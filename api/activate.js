...
// The Redis Cloud integration usually injects the connection string as
// REDIS_URL. If yours used a different name, check Vercel → Settings →
// Environment Variables and update the fallback list below.
const REDIS_URL =
...
export default async function handler(req, res) {
  ...
  try {
    ...
    await redis.set(regKey, JSON.stringify(existing));
